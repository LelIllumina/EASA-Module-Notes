...
- Mixture: Physically bonded Elements
- Isotope: Same elements with different amounts of neutrons, they are chemically the same as they have the same number of protons, but have different Atomic Mass (ignoring reactivity)

## Examples

- Compounds in aviation
	- Water for hydraulics
